                ...
                <form id="formCliente" name="formCliente" class="form-horizontal">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Identificación Empresarial <span class="required">*</span></label>
                        ...
                        <div class="form-group col-md-12">
                            <label>Dirección Empresa <span class="required">*</span></label>
            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td>Apellidos:</td>
                            <td id="celApellido">Ramos</td>
                        </tr>
                        <tr>
                            <td>Teléfono:</td>
                            <td id="celTelefono">3112222</td>
                        </tr>
                        <tr>
                            <td>Email (Usuario):</td>
                            <td id="celEmail">jose@jose.com</td>
                        </tr>
                        <tr>
                            <td>Identificación:</td>
                            <td id="celIde">111111</td>
                        </tr>
                        <tr>
                            <td>Nombre Fiscal:</td>
                            <td id="celNomFiscal">Nombre Empresa</td>
                        </tr>
                        <tr>
                            <td>Dirección Fiscal:</td>
                            <td id="celDirFiscal">Cali</td>
                        </tr>
                        <tr>
                            <td>Fecha registro:</td>
                            <td id="celFechaRegistro">Valle</td>
                        </tr>
                    </tbody>
                </table>
            </div>
